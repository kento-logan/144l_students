...
toc<- joined %>% 
  ...
  rename(sd_TOC= TOC_sd,
         sd_PTOC= PTOC_sd) %>% 
  select(Bottle:Datetime, hours, days, everything(), -c(contains("Sample"), interv))
```

\#PLOT THE CURVES \#\#Pivot\!\!\!\!
...
pivot_toc_sd<- toc %>% 
  select(Location,Bottle,Treatment,days,sd_TOC,sd_PTOC) %>% 
...
```
    ...
    ## Joining, by = c("Location", "Bottle", "Treatment", "days", "sample")
...
![](2018_TOC_DOC_Analysis_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
```
    ...
    ## Warning: package 'lmodel2' was built under R version 4.0.3
...
![](2018_TOC_DOC_Analysis_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
```
    ...
    ## Joining, by = c("Bottle", "Timepoint", "Treatment", "Target_DOC_Amendment", "Inoculum_L", "Media_L", "Datetime", "hours", "days", "Experiment", "Location", "Temperature", "Depth")
...
![](2018_TOC_DOC_Analysis_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](2018_TOC_DOC_Analysis_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
